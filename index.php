  ...
  <body>
	...
	<?php
		...
		if($sistema_web=='interno'){
			$status_cata = 'display:none;';	//ojo colocar zerocool en el display para volver a estado anterior	
            ...
            <div id="noticias-scroll" class="centrar">
              <ul>                
				...
				if($sistema_web=='externo'){
					...
					echo "<li><a href=\"videos.php\">Revive el día del operador - ver video -</a></li>";
      ...
      <div id="sidebar" class="caja tablet-35 web-35">
        ...
        <div class="widgets">
          ...
          <div class="caja--actividades">
            <ul id="demo2">
			  <?php
				//paso por metodo GET la variable de la galeria que quiero mostrar
				$lanzamiento = "lanzamiento";
				$end_year = "navidad";
				
				if($sistema_web=='interno'){
					echo "<li><a href=\"galeria-de-imagenes.php?evento=",urlencode($end_year)," \"><img src=\"img/banner/galeria-end-year.jpg\" alt=\"\"></a></li>";
				}
				
				while($reg=mysqli_fetch_array($registros_banner_left_01)){					
					$nombre_banner = $reg['nombre_banner'];
					echo "<li><a href=\"galeria-de-imagenes.php?evento=",urlencode($lanzamiento)," \"><img src=\"img/banner/$nombre_banner\" alt=\"\"></a></li>";
				}
