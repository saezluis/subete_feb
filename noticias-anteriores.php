  ...
  <body>
	<?php
		...
		*/
		...
		$registrosNoticias=mysqli_query($conexion,"select * from noticias where id_noticias != $noticia_send")
        ...
        <div class="caja web-25">
          ...
          <form method="post" id="footer" class="right">
			...
			<?php
				...
				echo "<input type=\"text\" name=\"noticia_send\" value=\"$noticia_send\" hidden=hidden>";	
			?>
          </form>
