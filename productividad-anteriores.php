  ...
  <body>
	<?php
		...
		*/
		...
		$produ_send = $_REQUEST['produ_send'];
		
		
		$registrosProductividad=mysqli_query($conexion,"select * from produ where id_produ != $produ_send")
        ...
        <div class="caja web-25">
          <form method="post" id="footer" class="right">
			...
			<?php
				...
				echo "<input type=\"text\" name=\"produ_send\" value=\"$produ_send\" hidden=hidden>";	
			?>
          </form>
        </div>
      </div>
