  ...
  <body>
	<?php
		...
		*/
		...
		$superacion_send = $_REQUEST['superacion_send'];
		
		
		$registrosSuperacion=mysqli_query($conexion,"select * from superacion where id_superacion != $superacion_send")
        ...
        <div class="caja web-25">
          <form method="post" id="footer" class="right">
			...
			<?php
				...
				echo "<input type=\"text\" name=\"superacion_send\" value=\"$superacion_send\" hidden=hidden>";	
			?>
          </form>
        </div>
      </div>
