  ...
  <body>
    ...
    <div id="main" class="grupo">
      ...
      <div id="content" class="caja web-65">
        <div class="caja base-50"><img src="img/royalito.png" alt="royalito"></div>
        <div class="caja base-50"> 
          <p class="proximamente">Muy pronto <br>un completo catálogo para ti.</p><a href="index.php" class="patras">Volver al inicio</a>
        </div>
      </div>
    </div>
    <footer class="total">
