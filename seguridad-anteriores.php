  ...
  <body>
	<?php
		...
		*/
		...
		$seguridad_send = $_REQUEST['seguridad_send'];
		
		
		$registrosSeguridad=mysqli_query($conexion,"select * from seguridad where id_seguridad != $seguridad_send")
    ...
    <div id="main" class="grupo">
      ...
      <div id="content" class="caja tablet-65 web-65">
        <div id="registro_publicaciones">
          ...
          <ul class="anteriores">
			<?php
				while($reg=mysqli_fetch_array($registrosSeguridad)){					
        ...
        <div class="caja web-25">
          <form method="post" id="footer" class="right">
			...
			<?php
				...
				echo "<input type=\"text\" name=\"seguridad_send\" value=\"$seguridad_send\" hidden=hidden>";	
			?>
          </form>
        </div>
      </div>
